...
import type {
	OracleWriteOptions,
	UseSimulateAddResolverOptions,
	UseSimulateAskBooleanOracleOptions,
	UseSimulateAskNumericOracleOptions,
	UseSimulateAskOracleOptions,
	UseSimulateGrantRoleOptions,
	UseSimulateProvideAnswerOptions,
	UseSimulateRemoveResolverOptions,
	UseSimulateRenounceRoleOptions,
	UseSimulateRevokeRoleOptions,
	UseSimulateSetFeeOptions,
	UseSimulateSetFeeRecipientOptions,
} from "../types";
...
export function useSimulateProvideAnswer({
	...
	return useSimulateContract({
		...
		args: [BigInt(params.questionId), params.answerData],
		chainId: params.chainId,
		query: options.query,
	});
}
