...
// Query option types
export interface UseQuestionQueryOptions extends Omit<UseQueryOptions<any>, "queryKey" | "queryFn"> {
  questionId: bigint;
  enabled?: boolean;
}
...
export interface UseFeeRecipientQueryOptions extends Omit<UseQueryOptions<Address>, "queryKey" | "queryFn"> {
  enabled?: boolean;
}
